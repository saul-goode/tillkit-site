          ...
          <tbody>
            ${ordersResult.items.slice(0, 5).map((o) => `
              <tr class="border-t border-slate-200">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900"><span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${o.status === "pending" ? "bg-yellow-100 text-yellow-800" : o.status === "paid" ? "bg-green-100 text-green-800" : o.status === "fulfilled" ? "bg-blue-100 text-blue-800" : o.status === "cancelled" ? "bg-red-100 text-red-800" : "bg-slate-100 text-slate-800"}">${o.status}</span></td>
          ...
          <tbody>
            ${result.items.map((p) => `
              <tr class="border-t border-slate-200">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900"><span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${p.status === "active" ? "bg-green-100 text-green-800" : p.status === "draft" ? "bg-slate-100 text-slate-800" : p.status === "archived" ? "bg-red-100 text-red-800" : "bg-slate-100 text-slate-800"}">${p.status}</span></td>
                <td class="actions">
